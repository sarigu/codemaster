      ...
      <div class="container-fluid">
        <div class="row justify-content-between">
          <div class=" col-md-4 col-lg-3  bg-darkblue-box">
            ...
            <div id="overview">
              <button class="topic-btn white active">1. Topic 1</button>
              ...
              <!--2-->
              <button class="topic-btn  white">2. Topic 2</button>
              ...
              <!--3-->
              <button class="topic-btn  white">3. Topic 3</button>
              <div class="lessons-list  white">
                <ul>
                  <li >
                    <div class="heart-icon"></div>
              ...
              <!--4-->
              <button class="topic-btn  white">4. Topic 4</button>
              <div class="lessons-list  white">
                <ul>
                  <li >
                    <div class="heart-icon"></div>
              ...
              <!--5-->
              <button class="topic-btn  white">5. Topic 5</button>
              <div class="lessons-list  white">
                <ul>
                  <li >
                    <div class="heart-icon"></div>
              ...
              <!--6-->
              <button class="topic-btn  white">6. Topic 6</button>
              <div class="lessons-list  white">
                <ul>
                  <li >
                    <div class="heart-icon"></div>
